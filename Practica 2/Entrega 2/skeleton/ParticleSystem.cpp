...
ParticleSystem::ParticleSystem(Vector3 point, float time) :
...
void ParticleSystem::add(Vector3 p, Vector3 v, Vector3 a, float d, float m, float r, Vector4 c, float time)
{
...
void ParticleSystem::addNRandomParticles(int n)
{
	for (int i = 0; i < n; i++) {
